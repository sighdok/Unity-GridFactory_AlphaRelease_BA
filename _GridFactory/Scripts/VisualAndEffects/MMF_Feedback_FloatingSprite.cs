...
namespace MoreMountains.Feedbacks
{
    ...
    [FeedbackPath("_OWN/Floating Sprite")]
    public class MMF_FloatingSprite : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMFloatingSpriteSpawnEvent.Trigger(ChannelData, _playPosition, _value, Direction, Intensity * intensityMultiplier, ForceLifetime, Lifetime, ForceColor, AnimateColorGradient,
