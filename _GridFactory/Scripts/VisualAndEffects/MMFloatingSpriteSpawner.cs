...
namespace MoreMountains.Feedbacks
{
	...
	/// </summary>
	public struct MMFloatingSpriteSpawnEvent
	{
		...
		public delegate void Delegate(MMChannelData channelData, Vector3 spawnPosition, Sprite value, Vector3 direction, float intensity,
		...
		static public void Trigger(MMChannelData channelData, Vector3 spawnPosition, Sprite value, Vector3 direction, float intensity,
			bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, bool useUnscaledTime = false, Transform attachmentTransform = null)
		{
	...
	/// It requires as input a MMFloatingSprite object.
	/// </summary>
	public class MMFloatingSpriteSpawner : MMMonoBehaviour
	{
		...
		public MMFloatingSprite PooledSimpleMMFloatingText;
		/// the prefabs to spawn (ignored if in simple mode)
		[Tooltip("the prefabs to spawn (ignored if in simple mode)")]
		public List<MMFloatingSprite> PooledMultipleMMFloatingText;
		...
		protected MMFloatingSprite _floatingText;
		...
		protected virtual void InstantiateMultiplePool()
		{
			...
			foreach (MMFloatingSprite obj in PooledMultipleMMFloatingText)
			{
		...
		public virtual void Spawn(Sprite value, Vector3 position, Vector3 direction, float intensity = 1f,
			...
			Transform attachmentTransform = null)
		{
			...
			_floatingText = nextGameObject.MMGetComponentNoAlloc<MMFloatingSprite>();
		...
		/// <param name="forceColor"></param>
		/// <param name="animateColorGradient"></param>
		public virtual void OnMMFloatingSpriteSpawnEvent(MMChannelData channelData, Vector3 spawnPosition, Sprite value, Vector3 direction, float intensity,
			bool forceLifetime = false, float lifetime = 1f, bool forceColor = false, Gradient animateColorGradient = null, bool useUnscaledTime = false, Transform attachmentTransform = null)
		{
		...
		{
			MMFloatingSpriteSpawnEvent.Register(OnMMFloatingSpriteSpawnEvent);
		}
		...
		{
			MMFloatingSpriteSpawnEvent.Unregister(OnMMFloatingSpriteSpawnEvent);
		}
