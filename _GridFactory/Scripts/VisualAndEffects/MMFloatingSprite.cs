...
namespace MoreMountains.Feedbacks
{
    ...
    /// </summary>
    public class MMFloatingSprite : MonoBehaviour
    {
        [Header("Bindings")]
        ...
        public SpriteRenderer TargetTextMesh;
        ...
        protected MMFloatingSpriteSpawner.AlignmentModes _alignmentMode;
        ...
        {
            if (_alignmentMode == MMFloatingSpriteSpawner.AlignmentModes.Fixed)
            {
                MovingPart.transform.up = _fixedAlignment;
            }
            else if (_alignmentMode == MMFloatingSpriteSpawner.AlignmentModes.MatchInitialDirection)
            {
                MovingPart.transform.up = this.transform.up;
            }
            else if (_alignmentMode == MMFloatingSpriteSpawner.AlignmentModes.MatchMovementDirection)
            {
        ...
        public virtual void SetProperties(Sprite value, float lifetime, Vector3 direction, bool animateMovement,
            MMFloatingSpriteSpawner.AlignmentModes alignmentMode, Vector3 fixedAlignment,
        ...
        public virtual void SetSprite(Sprite newValue)
        {
            TargetTextMesh.sprite = newValue;
        }
