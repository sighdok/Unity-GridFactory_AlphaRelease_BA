...
{
    public class MetaConveyorBase : MonoBehaviour, IItemEndpoint
    {
        private static readonly List<MetaConveyorBase> s_allConveyors = new List<MetaConveyorBase>();

        private readonly struct MetaConveyorMove
        {
            public readonly MetaConveyorBase from;
            public readonly MetaConveyorBase to;
            public readonly Item item;

            public MetaConveyorMove(MetaConveyorBase from, MetaConveyorBase to, Item item)
            {
                this.from = from;
                this.to = to;
                this.item = item;
        ...
        public static void TickAllConveyors()
        {
            ...
            var plannedMoves = new List<MetaConveyorMove>(s_allConveyors.Count);
            var usedTargets = new HashSet<MetaConveyorBase>();
            ...
            foreach (var conv in s_allConveyors)
            {
                ...
                MetaCell nextCell = conv.GrM.GetCell(nextPos);
                ...
                plannedMoves.Add(new MetaConveyorMove(conv, nextConv, conv.CurrentItem));
        ...
        private MetaGridManager GrM => MetaGridManager.Instance;
        private MetaCell _cell;
        ...
        public void ActivateAfterLoadOrPlace()
        {
